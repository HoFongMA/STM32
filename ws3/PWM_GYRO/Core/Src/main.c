...
HAL_StatusTypeDef MPU6050_Init( void )
{
	...
	if( HAL_I2C_Mem_Read_IT( &hi2c1, MPU6050_ADDR, WHO_AM_I_REG, 1, &check, 1 ) != HAL_OK ){
		return HAL_ERROR;
	}
	return HAL_OK;
/*
...
//	HAL_I2C_Mem_Read_IT( &hi2c1, MPU6050_ADDR, ACCEL_XOUT_H_REG, 1, rec_data, 6 );
/*
